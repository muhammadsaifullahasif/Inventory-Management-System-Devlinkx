...
Route::middleware(['auth'])->group(function () {
    ...
    // Market Research (eBay competitor price comparison)
    ...
    Route::get('/ebay/notifications/subscribed/{id}', [EbayController::class, 'getNotificationEvents'])->name('ebay.notifications.subscribed');
    ...
    Route::post('/orders/{id}/generate-multi-labels', [OrderController::class, 'generateMultiPackageLabels'])->name('orders.generate-multi-labels');
