                                    ...
                                    <div class="dropdown-menu p-2" id="categoryDropdownMenu" style="max-height: 250px; overflow-y: auto; min-width: 220px;">
                                        @forelse($categories as $category)
                                            <div class="form-check">
                                                <input class="form-check-input category-filter-checkbox" type="checkbox" name="category_id[]" value="{{ $category->id }}" id="cogs_report_category_{{ $category->id }}"
                                                    {{ in_array($category->id, $categoryIds) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="cogs_report_category_{{ $category->id }}">
                                                    {{ $category->name }}
                                                </label>
                                            </div>
                                        @empty
                    ...
                    <div class="card bg-soft-primary">
                        <div class="card-body py-3">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="text-muted mb-1 small">Sale Lines @include('partials.info-tooltip', ['text' => 'Sum of item quantity for order_items with cost recorded (inventory_updated=true), OR belonging to a cancelled/refunded order, OR with no matched product - across ANY payment/order status (no paid-only filter). Cancelled-order items zeroed; a bundle counts once (its summary line).'])</h6>
                ...
                <div class="col-md-3">
                    <div class="card bg-soft-success">
                        <div class="card-body py-3">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="text-muted mb-1 small">Total Revenue @include('partials.info-tooltip', ['text' => 'Sum of order_items.total_price across the same item set as Total Items Sold, with refunded items zeroed to $0 (cost still counted for them - the product wasnt returned).'])</h6>
                ...
                <div class="col-md-3">
                    <div class="card bg-soft-danger">
                        <div class="card-body py-3">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="text-muted mb-1 small">Total COGS @include('partials.info-tooltip', ['text' => 'Sum of cost_at_sale x quantity across the same item set as Total Items Sold. Cancelled orders (inventory restored) contribute $0.'])</h6>
                ...
                <div class="col-md-3">
                    <div class="card bg-soft-info">
                        <div class="card-body py-3">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="text-muted mb-1 small">Gross Profit @include('partials.info-tooltip', ['text' => 'Total Revenue minus Total COGS (this report\'s own revenue/COGS definitions - no payment_status=paid requirement, unlike the Gross Profit Report).'])</h6>
