...
@section('header')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 d-inline mr-2">Permissions</h1>
            ...
            <form action="{{ route('permissions.index') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('permissions.index') }}" class="btn btn-secondary btn-sm"><i class="fas fa-times mr-1"></i>Clear</a>
                    </div>
                    <div class="col-md-2 mb-2 d-flex align-items-end justify-content-end">
                        <span class="text-muted small">{{ $permissions->total() }} results</span>
                    </div>
                </div>
            </form>
        </div>
            ...
            <tbody>
                @forelse ($permissions as $permission)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('permissions.edit', $permission->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                <form action="{{ route('permissions.destroy', $permission->id) }}" method="POST" id="permission-{{ $permission->id }}-delete-form">
                                    @csrf
                                    @method('DELETE')
                                </form>
                                <a href="javascript:void(0)" data-id="{{ $permission->id }}" class="btn btn-danger btn-sm delete-btn"><i class="fas fa-trash"></i></a>
                            </div>
                        </td>
                    </tr>
                @empty
