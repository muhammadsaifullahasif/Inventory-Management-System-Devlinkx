        ...
        <div class="card">
            <div class="card-body pb-0 d-flex align-items-center justify-content-between">
                ...
                <div class="ms-auto d-flex align-items-center gap-2">
                    ...
                    @endphp
                    @include('partials.column-toggle', ['tableId' => 'roleTable', 'cookieName' => 'role_columns', 'columns' => $roleColumns])
                </div>
            </div>
                        ...
                        <tbody>
                            @forelse ($roles as $role)
                                <tr>
                                    ...
                                    @endcan
                                    <td data-column="id">{{ $role->id }}</td>
                                    <td data-column="name"><span class="fw-semibold">{{ $role->name }}</span></td>
                                    <td data-column="created_at"><span class="fs-12 text-muted">{{ \Carbon\Carbon::parse($role->created_at)->format('d M, Y') }}</span></td>
                                    <td>
