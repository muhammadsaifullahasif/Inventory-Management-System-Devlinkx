    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Edit Shipping Carrier</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('shipping.index') }}">Shipping</a></li>
                <li class="breadcrumb-item">Edit Carrier</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    @can('view shipping')
                        <a href="{{ route('shipping.show', $shipping->id) }}" class="btn btn-primary">
            ...
            <form action="{{ route('shipping.update', $shipping->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="account_number" value="{{ old('account_number', $shipping->account_number) }}" class="form-control" placeholder="Carrier account number">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="shipper_phone" value="{{ old('shipper_phone', $shipping->shipper_phone) }}" class="form-control" placeholder="e.g. 8321234567">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 d-flex align-items-end">
                        <div class="form-check form-switch">
                            <input type="checkbox" class="form-check-input" id="is_sandbox" name="is_sandbox" value="1"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" class="form-check-input" id="is_address_validation" name="is_address_validation" value="1"
                ...
                <div class="d-flex gap-2 mt-3">
                    <button type="submit" class="btn btn-primary">
                        <i class="feather-save me-2"></i>Update Carrier
                    </button>
