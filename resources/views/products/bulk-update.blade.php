...
@section('header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Bulk Update Products</h1>
                </div>
                <div class="col-sm-6">
...
@section('content')
            ...
            <form action="{{ route('products.bulk-update.form') }}" method="GET" id="filterForm">
                <div class="row align-items-end">
                    <div class="col-md-4 mb-2">
                        <label class="small mb-1">Search (Name / SKU / Barcode)</label>
                    ...
                    <div class="col-md-2 mb-2">
                        ...
                        <a href="{{ route('products.bulk-update.form') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h3 class="card-title mr-3">Products</h3>
