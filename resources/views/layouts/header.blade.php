                ...
                <div class="nxl-lavel-mega-menu-wrapper d-flex gap-3">
                    ...
                    <div class="dropdown nxl-h-item nxl-lavel-menu">
                        ...
                        <div class="dropdown-menu nxl-h-dropdown">
                            ...
                            <a href="{{ route('sales-channels.create') }}" class="dropdown-item">
                            ...
                            <a href="{{ route('shipping.create') }}" class="dropdown-item">
                            ...
                            <div class="dropdown nxl-level-menu">
                                ...
                                <div class="dropdown-menu nxl-h-dropdown">
                                    <a href="{{ route('warehouses.create') }}" class="dropdown-item">
                                        <i class="wd-5 ht-5 bg-gray-500 rounded-circle me-3"></i>
                                        <span>Add Warehouse</span>
                                    </a>
                                    <a href="{{ route('racks.create') }}" class="dropdown-item">
                                        <i class="wd-5 ht-5 bg-gray-500 rounded-circle me-3"></i>
                                        <span>Add Rack</span>
                                    </a>
                                </div>
                            ...
                            <div class="dropdown nxl-level-menu">
                                ...
                                <div class="dropdown-menu nxl-h-dropdown">
                                    ...
                                    <a href="{{ route('permissions.create') }}" class="dropdown-item">
                                        <i class="wd-5 ht-5 bg-gray-500 rounded-circle me-3"></i>
            ...
            <div class="d-flex align-items-center">
                ...
                {{-- <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                    <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                        <img src="{{ asset('vendors/img/flags/4x3/us.svg') }}" alt="" class="img-fluid wd-20" />
                    </a>
                ...
                <div class="dropdown nxl-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('images/avatar/undefined.png') }}" alt="user-image" class="img-fluid user-avtar" />
                                <div>
                                    <h6 class="text-dark mb-0 d-flex flex-wrap">
                                        {{ auth()->user()->name }} 
                                        @foreach (auth()->user()->roles as $role)
                                            <span class="badge bg-soft-success text-success ms-1">{{ $role->name }}</span>
                                        @endforeach
                        ...
                        <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('nav-logout-form').submit();" title="Logout" class="dropdown-item" role="button">
