...
class ShippingController extends Controller
{
    ...
    {
        $request->validate(["name"=>"required|string|max:255","type"=>"required|string|max:100","account_number"=>"nullable|string|max:255","api_endpoint"=>"nullable|url|max:500","sandbox_endpoint"=>"nullable|url|max:500","tracking_url"=>"nullable|url|max:500","default_service"=>"nullable|string|max:255","weight_unit"=>"required|in:lbs,kg,oz,g","dimension_unit"=>"required|in:inches,cm","client_id"=>"nullable|string|max:500","client_secret"=>"nullable|string|max:500","shipper_name"=>"nullable|string|max:255","shipper_phone"=>"nullable|string|max:20","shipper_address"=>"nullable|string|max:255","shipper_city"=>"nullable|string|max:100","shipper_state"=>"nullable|string|max:2","shipper_postal_code"=>"nullable|string|max:20","shipper_country"=>"nullable|string|max:2"]);
