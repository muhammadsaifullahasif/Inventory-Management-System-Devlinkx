...
class ComparisonReportExport implements FromArray, WithHeadings, WithStyles, WithTitle
{
    protected $data;
    protected $summary;
    protected $groupBy;
    ...
    public function array(): array
    {
        ...
        // Add summary section
        $rows[] = ['COGS vs Gross Profit Comparison Report'];
        $rows[] = [];
        $rows[] = ['Summary Metrics', 'Value'];
    ...
    {
        if ($this->groupBy === 'product') {
            return ['Product', 'SKU', 'Qty', 'Revenue', 'COGS', 'Gross Profit', 'Margin %', 'Avg Cost', 'Avg Price'];
        } elseif ($this->groupBy === 'channel') {
