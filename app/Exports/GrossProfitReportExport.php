...
class GrossProfitReportExport implements FromArray, WithHeadings, WithStyles, WithTitle
{
    protected $data;
    protected $summary;
    protected $groupBy;
    ...
    public function array(): array
    {
        ...
        // Add summary section
        $rows[] = ['Gross Profit Report Summary'];
        $rows[] = ['Sale Lines', number_format($this->summary['sale_lines'] ?? 0, 0)];
        ...
        $rows[] = ['Avg Profit per Item', number_format($this->summary['avg_profit_per_item'] ?? 0, 2)];
        $rows[] = []; // Empty row

        // Add data rows (same structure as COGS report)
